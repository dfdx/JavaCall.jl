...
function globalref(ref::Ptr)
    ccall(jnifunc.NewGlobalRef, Ptr{Void}, (Ptr{JNIEnv}, Ptr{Void}), penv, ref)
end
...
function deleteref(x::JavaObject)
    ...
    ccall(jnifunc.DeleteGlobalRef, Void, (Ptr{JNIEnv}, Ptr{Void}), penv, x.ptr)
